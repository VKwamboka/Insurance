    ...
    <main>
      <div>
        ...
        <div
          ...
          id="price"
        >
          {/* <header className="max-w-6xl mx-auto py-64 px-5 flex justify-between lg:px-8">
            <a href="#/" className="text-2xl text-gray-900 font-semibold">
              price<span className="text-violet-600">ly</span>
            </a>
          </header> */}
          <main className="max-w-6xl mx-auto py-64  px-8">
            <div className="max-w-md mx-auto mb-14 text-center">
              <h1 className="text-4xl font-semibold mb-6 lg:text-5xl">
                <span className="text-violet-600">Flexible</span> Plans
              </h1>
            ...
            <div className="flex flex-col justify-between items-center lg:flex-row lg:items-start">
              <div className="w-full flex-1 mt-8 p-8 order-1 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-1 lg:rounded-r-none">
                ...
                <a
                  href="#/"
                  className="flex justify-center items-center bg-violet-900 rounded-xl py-6 px-4 text-center text-white text-2xl"
                >
                  Choose Plan
                  <img
              ...
              <div className="w-full flex-1 p-8 order-2 shadow-xl rounded-3xl bg-gray-900 text-gray-400 sm:w-96 lg:w-full lg:order-2 lg:mt-0">
